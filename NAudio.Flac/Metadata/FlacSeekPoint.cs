...
namespace NAudio.Flac.Metadata
{
    ...
    public class FlacSeekPoint
    {
        ...
        /// <summary>
        ///     Gets the sample number of the first sample in the target frame, or <see cref="PlaceHolderPointSampleNumber" /> for
        ///     a placeholder point.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        ///     Gets the offset (in bytes) from the first byte of the first frame header to the first byte of the target frame's
        ///     header.
        /// </summary>
        /// <value>
