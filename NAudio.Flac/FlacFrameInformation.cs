...
{
    /// <summary>
    ///     Provides some basic information about a flac frame. This structure is typically used for implementing a seeking
    ///     algorithm.
    /// </summary>
    ...
    public struct FlacFrameInformation
    {
        ...
        /// <summary>
        ///     Gets a value which indicates whether the described frame is the first frame of the flac stream. True means that the
        ///     described frame is the first frame of the flac stream. False means that the described frame is not the first frame
        ///     of the flac stream.
        /// </summary>
