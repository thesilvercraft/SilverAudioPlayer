...
public partial class PictureForm : Form
{
    ...
    private void ChangePicture()
    {
        ...
        Text = "Picture " + (CurrentPictureIndex + 1) + " of " + Pictures.Count + " - " + pictureBox1.Image.Width +
               "x" + pictureBox1.Image.Height + " - " + Pictures[CurrentPictureIndex].Position + " - " +
               Pictures[CurrentPictureIndex].PicType + " - " + Pictures[CurrentPictureIndex].Description + " - " +
               Pictures[CurrentPictureIndex].Hash + " - " + Pictures[CurrentPictureIndex].MimeType;
    }
